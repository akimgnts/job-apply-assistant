...
Evidence ID format: Canonical IDs from Evidence Registry (SIDEL.DATA_BI.001, SKILL.PYTHON, etc.)
...
async def analyze_and_enrich_job_offer(
    ...
    try:
        ...
        # Note: skill_evidence_map is stored in analysis_json (single source of truth)
